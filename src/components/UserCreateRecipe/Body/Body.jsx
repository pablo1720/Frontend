...
const Body = ({ loginUserInfo }) => {
    ...
    const onSubmit = async (values, { resetForm }) => {
        try {
            const recipeValues = {
                nombre: values.recipeTitle,
                ingredientes: values.ingredients,
                descripcion: values.recipeDescription,
                tiempo_preparacion: values.recipeTime,
                dificultad: 'Facil',
                instrucciones: values.steps,
                imagen: values.imgRecipe,
                cantidad_personas: values.recipePeople,
                costo_monetario: values.recipePrice,
                id_usuario: loginUserInfo.id,
            };
            
            await publishRecipe(recipeValues);
            resetForm();
        } catch (error) {
